...
LABEL "org.opencontainers.image.source"="https://github.com/hookerz/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/hookerz/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/hookerz/action-slack-notify
