...
LABEL "org.opencontainers.image.source"="https://github.com/draeton/action-slack-notify"

WORKDIR ${GOPATH}/src/github.com/draeton/action-slack-notify
COPY main.go ${GOPATH}/src/github.com/draeton/action-slack-notify
